...
REGISTER SELECTION — pick exactly one of four:

warm_emotional
  Use when: cold or wet weather, user is stationary or strolling slowly, daytime comfort context (café, bakery).
...
quiet_premium
  Use when: evening, premium category (wine bar, bookshop, fine dining, late-evening cafés), user is calm or stationary.
  Tone: minimal, refined, understated. No superlatives. Restraint is the point.
  Colors: off-white, muted navy, dark slate, soft greys.
